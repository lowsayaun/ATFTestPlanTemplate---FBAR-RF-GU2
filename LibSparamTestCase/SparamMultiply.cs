...
{
    public class SparamMultiply : SparamTestCase.TestCaseAbstract
    {
        int val_1, val_2;
        public override void Initialize()
        {
            ...
            {
                DisplayError("SparamMultiply", "Initialize - wrong input " + UsePrevious, "Use_Previous column data must in this format - (2,6)");
            }
