...
{
    public class N9020A : IISigAnalyzer
    {
        ...
        #region iSigAnalyzer
        void IISigAnalyzer.Initialize(int equipId)
        {
        ...
        {
            _myVisaSa.WriteString("INIT:CONT 0", true);
        }
        ...
        void IISigAnalyzer.TRACE_AVERAGE(int avg)
        {
            ...
            _myVisaSa.WriteString(":TRAC:TYPE AVER", true);
        }
        ...
        void IISigAnalyzer.SET_TRACE_DETECTOR(string mode)
        {
            switch (mode.ToUpper())
            {
                case "WRIT":
                case "WRITE":
                    _myVisaSa.WriteString("TRAC:TYPE WRIT", true);
                    break;
                case "MAXH":
                case "MAXHOLD":
                    _myVisaSa.WriteString("TRAC:TYPE MAXH", true);
                    break;
                case "MINH":
                case "MINHOLD":
                    _myVisaSa.WriteString("TRAC:TYPE MINH", true);
                    break;
            }
        }
